...
The likelihood of a source in \textbf{csky} is shown in the equation below,
\begin{equation}
  \CL(n_s,\Vmu)
  = \prod_i \Gb{
...
Its ratio is calculated apriori.
The spatial PDF of the signal $\CS_S(\delta)$ depends on the declination of the event and corresponds to a Kent distribution around the declination of the source.
