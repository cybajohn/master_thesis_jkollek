...
\begin{figure}
    ...
    \caption{Histogram of the background time window lengths $dt$ of source number $\num{11}$ for the time-dependent analysis.}
...
\begin{figure}
    ...
    \caption{Histogram of the fitted number of signal events $\hat{n}_\text{S}$ in dependence of the time window lengths $dt$ of the background trials for the time-dependent analysis for source number $\num{11}$.}
...
This may involve the combinatorics of the length of the time window and the signal or the time window fit in general, since signal parameter and the setting of the time window are not independent of each other.
