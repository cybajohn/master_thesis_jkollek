...
This analysis uses an untriggered flare procedure in which the time window of the flare is centered around the time $t_0$ of the source while the length $dt$ of the flare in the shape of a box is fitted.
