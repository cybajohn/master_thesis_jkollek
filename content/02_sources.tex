...
\begin{table}[!htb]
  \caption{Table of the 72 GFU-gold events used as sources in this analysis. Shown are the features time in MJD, declination $\delta$ in radian and right ascension $\alpha$ also in radian. The time-dependent analysis uses a subset of these sources.}
  \label{tab:sources}
  \begin{subtable}{.5\linewidth}
  \centering
  \begin{tabular}{cccc}
    \toprule
    Nr. & MJD &  $\delta$ in $\si{\radian}$ & $\alpha$ in $\si{\radian}$ \\
    \toprule
