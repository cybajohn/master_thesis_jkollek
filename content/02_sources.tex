...
\begin{figure}
    \centering
    \includegraphics[draft=false,width=\linewidth]{Plots/02_sources/gfu_gold_skymap.pdf}
    \label{fig:skymap_1}
...
\begin{figure}
    \centering
    \includegraphics[draft=false,width=\linewidth]{Plots/02_sources/gfu_gold_skymap_time_dep.pdf}
    \label{fig:skymap_2}
