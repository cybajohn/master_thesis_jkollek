...
\begin{figure}
  ...
  \end{tikzpicture}}
  \caption{Schematic visualisation of the cherenkov radiation $\gamma$ emitted by a charged lepton $l$ traveling with velocity $v>c/n$ trough a medium with a refractive index $n$ polarizing the medium on its way. The resulting cone of Cherenkov radiation is visually comparable to the supersonic cone of an aeroplane.}
  \label{fig:cherenkov}
\end{figure}
