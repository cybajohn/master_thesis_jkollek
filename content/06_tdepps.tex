...
So for the single event $i$ the test statistic becomes,
\begin{equation}
...
Deeper investigations led to the thought that there might be something fundamentally wrong with the tdepps software.
However, errors in the software could not be confirmed.
With these investigations being without results, termination of the usage of the modified \texttt{tdepps} software was imminent.
